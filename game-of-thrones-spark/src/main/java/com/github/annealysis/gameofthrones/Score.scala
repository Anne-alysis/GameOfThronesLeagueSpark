...
//    val correctAnswerDF = spark.read.csv(s"$bucket/$answerFile")
//
//    logger.info("Scoring the resposnes... ")
...
//    OutputHandling.writeScoresToFile()
...
object Score extends Score with App {
  ...
  val answerFile = "answer_truth.xlsx"
